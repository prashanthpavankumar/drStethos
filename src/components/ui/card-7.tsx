    ...
    return (
      ...
      >
        {imageUrl ? (
          ...
          <div className="absolute inset-0 h-full w-full bg-gradient-to-br from-green-800 to-teal-950 transition-transform duration-500 ease-in-out group-hover:scale-110"></div>
        )}
